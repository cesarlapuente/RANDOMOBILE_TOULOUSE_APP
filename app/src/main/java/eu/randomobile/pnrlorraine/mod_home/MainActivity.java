...
public class MainActivity extends Activity {
        ...
        mImageMap.addOnImageMapClickedHandler(new ImageMap.OnImageMapClickedHandler() {
            ...
            public void onImageMapClicked(int id, ImageMap imageMap) {
                ...
                if (mImageMap.getAreaAttribute(id, "name").equals(
                    ...
                    // Abrir la pantalla de info de toulouse
    ...
    private void updateLocalDatabase() {
        if (app.getNetStatus() != 0) {
            ...
            client_pages.get(MainActivity.this, "http://toulouse.randomobile.eu/api/routedata/pages/retrieve.json", new AsyncHttpResponseHandler() {
                @Override
